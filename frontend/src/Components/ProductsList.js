...
let result = await fetch('https://amrutam-jewellery.onrender.com/products',{
headers:{
...
const deleteProduct = async(id)=>{
    // console.log(id);
     ...
     let result = await fetch(`https://amrutam-jewellery.onrender.com/product/${id}`,{
        method: "Delete"  ,
          headers:{
 ...
 const searchhandle= async (event)=>{
    ...
    if(key){
        ...
        let result = await fetch(`https://amrutam-jewellery.onrender.com/search/${key}`,{
            headers:{
